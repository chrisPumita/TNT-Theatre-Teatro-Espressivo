            ...
            <div class="row" style="margin: 0;">
                    ...
                    <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-6 col-xxl-6 position-relative d-md-flex align-items-center ">
                        ...
                        <div class="row position-absolute bottom-0 start-50 translate-middle-x header-hoja" style="height: 150px; width:100%">
                            ...
                            <div class="col-6 col-sm-6 pt-sm-5">
                                <img class="img-responsive" src="./assets/img/cite.svg" alt="">
                            </div>
                        </div>
                    </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-5">
                        ...
                        <p class="mt-5 text-gray">
                            ...
                            a Londres, el público y la crítica se han emocionado con
                                ...
                                <div class="p-1 p-sm-2" style="margin-top: 0rem; border-radius: 2rem">
                                    ...
                                    <div class="tab-content border-tabs p-3 p-md-5" id="pills-tabContent">
                                        <div class="tab-pane fade show active text-light" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                            ...
                                            <p>
                                                La música en vivo y el teatro físico robusto crean una actuación
                                                apasionante. También hay humor, porque Shakespeare sabía que
                                                la tragedia es más fuerte si se contrapone con la risa.
                                            </p>
                                            <p>
